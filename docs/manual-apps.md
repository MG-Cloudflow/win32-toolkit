...
**you supply the installer, and everything after that is identical to the winget flow** — Sandbox/Hyper-V
...
```powershell
# 1. Scaffold — Install region is left for you
...
- It runs on target devices under **Windows PowerShell 5.1** — avoid PowerShell 7-only syntax.
