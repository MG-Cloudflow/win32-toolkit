@{
    ...
    FunctionsToExport = @('Invoke-Win32Toolkit', 'Test-Win32ToolkitProject', 'Export-Win32ToolkitIntuneWin', 'Publish-Win32ToolkitIntuneApp', 'New-Win32ToolkitManualApp', 'Complete-Win32ToolkitManualApp', 'Show-Win32Toolkit', 'New-Win32ToolkitTestVM', 'Reset-Win32ToolkitTestVM', 'Remove-Win32ToolkitTestVM')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
